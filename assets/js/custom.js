...
jQuery(document).ready(function ($) {
	...
	$('body').append('<script type="text/javascript" src="../assets/js/script.js"></script>');

	// Loading
	$('body.loading_page').prepend('<div class="loadingtt"><img src="../assets/images/loading.gif" /></div>');
	...
	$("#loginlink").click(function() {	
		...
		postVars = {
			...
			$.post("user-check",postVars,function(data){
				if(data.id > 0){
